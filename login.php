...
EOT2;
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<input id="login_input_username" type="text" name="user_name" required placeholder="Username (or email)" /> ';
        echo '<input id="login_input_password" type="password" name="user_password" required placeholder="Password" /> ';
        echo '<button type="submit"  class="btn btn-default" name="login">Login</button>';
        echo '</form>';
    ...
    {
		echo '<div class="col-sm-4 col-sm-offset-4">';
		echo '<div class="signup-form"><!--login form-->';
